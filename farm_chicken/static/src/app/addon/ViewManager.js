...
Ext.define('Ext.form.ViewManager', {
    ...
    saveRecord: function(mainView) {
        ...
        return promise.then(function(res) {
            ...
            self.handleError(err, {name: 'Fehler', message: 'Datensatz konnte nicht gespeichert werden'});
        });
    },
    
    /**
     * this method shows and Error and stops Loading
     * @unsupported forwarding (suppored in previous versions) is not supported anymore
     */
    handleError: function(err, alternativeError, callback) {
        this.stopLoading();
